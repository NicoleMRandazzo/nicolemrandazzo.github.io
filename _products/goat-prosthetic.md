...
<div style="max-width: 1000px; margin: 0 auto; padding: 20px;">
  ...
  <h3>Skills: SolidWorks, 3D Printing, Mold Casting, Engineering Drawings</h3>
  
  <p>
    &emsp;ADAPT Texas is an organization focused on adapting tools and technologies for people with disabilities. Beginning my Junior year in college, my team was tasked with developing prosthetics for a goat with a limp leg and a dog missing three limbs. I chose to focus primarily on the goat prosthetic. The objective of this project was to design and fabricate a custom prosthetic device for a goat with a lame leg to improve mobility, comfort, and overall quality of life. Both these animals belonged to Safe In Austin, an organization that takes in abused, neglected, or special needs animals to help support children with similar experiences. 	 	
  </p>
  
  <p>
    &emsp;At the start of our project, our team visited Safe in Austin to meet the animals and gather their anatomical measurements. We performed mold casting to obtain accurate limb geometry and observed how both animals moved. Conversations with the manager and long-time volunteers were essential to understanding the goat’s lifestyle, behavioral tendencies, and physical limitations. These discussions helped us define the key design requirements: comfort, durability, proper load distribution, ease of attachment, and long-term biomechanical compatibility.
  </p>
